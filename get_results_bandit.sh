...
echo "batch;file;data;fair;alpha;seed;eps;mu;nu;N;util_mean;util_FQ;util_TQ;acc_mean;acc_FQ;acc_TQ;DP_mean;DP_FQ;DP_TQ;FPR_mean;FPR_FQ;FPR_TQ;util_std;acc_std;DP_std;FPR_std;util_Q025;util_Q975;acc_Q025;acc_Q975;DP_Q025;DP_Q975;FPR_Q025;FPR_Q975" > "$1"
