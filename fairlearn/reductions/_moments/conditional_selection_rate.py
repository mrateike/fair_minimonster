...
from fairlearn._input_validation import _MESSAGE_RATIO_NOT_IN_RANGE, _KW_SENSITIVE_FEATURES
...
class ConditionalSelectionRate(ClassificationMoment):
    ...
    def signed_weights(self, lambda_vec):
        ...
        # no_signed_weights = pd.Series(np.zeros(self.tags.shape[0]))
        # signed_weights_all = pd.concat([signed_weights, no_signed_weights], axis=0, ignore_index=True)
        #
